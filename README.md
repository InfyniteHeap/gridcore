...
The core of GCL that implements almost all launcher functions, e.g. Microsoft OAuth2, Minecraft downloading and game mods managing.
...
Most use methods can be found in `tests` folder.
...
Before start contributing to this project, you should read this [Code of conduct](CODE_OF_CONDUCT.md).