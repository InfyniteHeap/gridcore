//! # File System
//! For better developing quality, all functions about file is simply wrapped here.
...
/// Create a file.
///
/// This function can automatically create a directory if the target directory in which files will be stored later do not esist.
pub fn create_file(dir: &str, file_name: &str) -> Result<fs::File, std::io::Error> {
